...
def animate_scatters(iteration, data, scatters, data2, scatters2):
   """
   ...
   animate_sctrs(iteration, data2, scatters2)
   return scatters

def animate_sctrs(iteration, data, scatters):
...
print(scatters_green_people)
print("////////////////////////")
full_scatters = scatters_green_people + scatters_blue_people
print(full_scatters)
# full_scatters = [ axes.scatter(full_data[0][i,0:1], full_data[0][i,1:2], full_data[0][i,2:]) for i in range(full_data[0].shape[0]) ]
